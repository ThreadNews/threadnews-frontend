...
import {UserBlock,UserBlockList} from './UserBlock'
...
export default function Profile(props){
    ...
    let user ={
        ...
        interests: ['Cars','Crypto','DIY','Sports'],
        ...
        follower_count:10,
        following_count:20,
        followers: ["a49387e4-7c51-11eb-95d3-acde48001122", "0e7bf4b8-7c28-11eb-95d3-acde48001122","1e0a2610-a672-11eb-a5a6-acde48001122"],
        following: ["a49387e4-7c51-11eb-95d3-acde48001122","a49387e4-7c51-11eb-95d3-acde48001122", "0e7bf4b8-7c28-11eb-95d3-acde48001122"],
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <div className="profile-head-text">
                                    ...
                                    {/* <p className="social">Followers : <span>{user.follower_count}</span></p>
                                    <p className="social">Followers : <span>{user.follower_count}</span></p> */}
